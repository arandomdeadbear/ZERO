...
const schema = require('@schema/leavelog');
...
module.exports = {
  ...
  async execute(client, member) {
    ...
    if(data) {
        ...
        const overlayIMG =
          'https://media.discordapp.net/attachments/933734336069509190/1060888374057128037/leaveoverlay.jpg?width=1025&height=376';
